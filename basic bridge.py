...
time_step = 5e-3                    # time step of simulation [s]
...
py1.SetPos(chrono.ChVectorD(-l/3,5+(1/2),5))
...
py2.SetPos(chrono.ChVectorD(l/3,5+(1/2),5))
...
deck1.SetPos(chrono.ChVectorD(0,15+((d)/2),5))
# deck1.SetBodyFixed(True)
# deck1.SetInertiaXX(chrono.ChVectorD(inertia("rect",1,1,l,w,d),inertia("rect",1,3,l,w,d),inertia("rect",1,2,l,w,d)))
