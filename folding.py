...
while (vis.Run() and system.GetChTime() < time_end):
    ...
    array_1x.append(joint1.Get_react_force().x)
    array_1y.append(joint1.Get_react_force().y)
    array_1z.append(joint1.Get_react_force().z)
    array_2x.append(joint2.Get_react_force().x)
    array_2y.append(joint2.Get_react_force().y)
    array_2z.append(joint2.Get_react_force().z)
    array_3x.append(joint3.Get_react_force().x)
    array_3y.append(joint3.Get_react_force().y)
    array_3z.append(joint3.Get_react_force().z)
